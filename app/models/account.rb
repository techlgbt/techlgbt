...
class Account < ApplicationRecord
  ...
  validates :username, format: { with: REMOTE_USERNAME_ONLY_RE }, length: { maximum: USERNAME_LENGTH_HARD_LIMIT }, if: -> { (remote? || actor_type_application?) && will_save_change_to_username? }
